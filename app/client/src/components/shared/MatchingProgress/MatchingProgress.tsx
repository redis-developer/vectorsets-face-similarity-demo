...
const MatchingProgress: React.FC<MatchingProgressProps> = ({ isSearching }) => {
  ...
  return (
    <div className={styles.matchingProgress}>
      <div className={styles.matchingText}>
        <span
          className={`${styles.matchingLabel} ${isSearching ? styles.searching : hasStarted ? styles.complete : styles.searching}`}
        >
          {isSearching
            ? 'Matching...'
            : hasStarted
